...
\begin{itemize}
	...
	\item \texttt{first\_cond} - index of the first involved constraint block used for condensing
	\item \texttt{cblock\_end} - end index of the constraint blocks used for condensing
\end{itemize}
