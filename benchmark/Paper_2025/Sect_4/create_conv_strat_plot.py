...
benchmark_file = 'blockSQP2_it_2026-08-22_13_54_57_106441.txt'
benchmark_data = parse_benchmark_file(str(cD / Path(f'out_conv_strategy_comparison/{benchmark_file}')))
...
if __name__ == '__main__':
    plot_dolan_more(benchmark_data)
