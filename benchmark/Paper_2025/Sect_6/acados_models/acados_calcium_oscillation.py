...
def export_calcium_model() -> AcadosModel:
    ...
    # Stage Cost: ||x - x_bar||^2 + p1 * w
    # Note: we only penalize the first 4 states
...
# Use IRK (Implicit Runge-Kutta) for stiff systems
