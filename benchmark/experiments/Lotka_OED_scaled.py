...
###############################################################################
USCALE = 0.1
OCprob = OCProblems.Lotka_OED_USCALE(nt = 100, parallel = True, integrator = 'RK4', USCALE = USCALE)
...
OCP_experiment.plot_successful(1, nPert0, nPertF, [None], EXP_N_SQP, EXP_N_secs, EXP_type_sol, dirPath = cD + "/out_Lotka_OED")
