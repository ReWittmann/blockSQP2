...
py::class_<blockSQP::SQPoptions>(m, "SQPoptions")
    ...
    .def_readwrite("kappaSOC", &blockSQP::SQPoptions::kappaSOC)
    .def_readwrite("gammaTheta", &blockSQP::SQPoptions::gammaTheta)
    .def_readwrite("gammaF", &blockSQP::SQPoptions::gammaF)
    .def_readwrite("eta", &blockSQP::SQPoptions::eta)
    ...
    .def_readwrite("test_opt_3", &blockSQP::SQPoptions::test_opt_3)
    .def_readwrite("test_opt_4", &blockSQP::SQPoptions::test_opt_4)
    .def_readwrite("test_opt_5", &blockSQP::SQPoptions::test_opt_5)
...
// py::enum_<blockSQP::SQPresults>(m, "SQPresults")
py::native_enum<blockSQP::SQPresults>(m, "SQPresults", "enum.Enum")
    .value("it_finished", blockSQP::SQPresults::it_finished)
    .value("partial_success", blockSQP::SQPresults::partial_success)
    .value("success", blockSQP::SQPresults::success)
    .value("super_success", blockSQP::SQPresults::super_success)
    .value("local_infeasibility", blockSQP::SQPresults::local_infeasibility)
    .value("restoration_failuer", blockSQP::SQPresults::restoration_failure)
    .value("linesearch_failure", blockSQP::SQPresults::linesearch_failure)
    .value("qp_failure", blockSQP::SQPresults::qp_failure)
    .value("eval_failure", blockSQP::SQPresults::eval_failure)
    .value("misc_error", blockSQP::SQPresults::misc_error)
    .finalize()
    ;
...
py::class_<blockSQP::SQPiterate>(m, "SQPiterate")
    ...
    .def("print_hess2", [](blockSQP::SQPiterate *vars){
