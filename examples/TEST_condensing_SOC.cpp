...
int main(){
    ...
    blockSQP::Matrix lb_con_2(7,1);
    blockSQP::Matrix ub_con_2(7,1);
    lb_con_2.Initialize(-0.1);
    ub_con_2.Initialize(-0.1);
    lb_con_2(6) = -1.5;
    ub_con_2(6) = 1.5;
...
/*
    ...
    std::cout << "############################full_condense, correct constraint bounds\n";
    std::cout << "Condensed hess =\n" << blockSQP::Matrix(condensed_hess[0]) << "\n";
    ...
    C->full_condense(grad_obj, con_jac, hess, lb_var, ub_var, lb_con_2, ub_con_2,
        condensed_h, condensed_Jacobian, condensed_hess, condensed_lb_var, condensed_ub_var, condensed_lb_con, condensed_ub_con
    );

    std::cout << "############################full_condense, false constraint bounds\n";
    std::cout << "Condensed linear form h =\n" << condensed_h << "\n";
    std::cout << "Condensed lb_var =\n" << condensed_lb_var << "\n\ncondensed_ub_var =\n" << condensed_ub_var << "\n";
    std::cout << "Condensed lb_con =\n" << condensed_lb_con << "\n\ncondensed_ub_con =\n" << condensed_ub_con << "\n";

    C->SOC_condense(grad_obj, lb_con, ub_con, condensed_h, condensed_lb_con, condensed_ub_con);

    std::cout << "############################SOC_condense, correct constraint bounds\n";
    std::cout << "Condensed linear form h =\n" << condensed_h << "\n";
    std::cout << "Condensed lb_var =\n" << condensed_lb_var << "\n\ncondensed_ub_var =\n" << condensed_ub_var << "\n";
    std::cout << "Condensed lb_con =\n" << condensed_lb_con << "\n\ncondensed_ub_con =\n" << condensed_ub_con << "\n";
