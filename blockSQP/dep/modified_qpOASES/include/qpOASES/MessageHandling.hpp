 ...
 *   \date 2023-2025
 *   Added returnValue RET_STOP_REQUESTED for when solver was
 * 	 asked to terminate through std::stop_token.
 * 	 Silenced THROWERROR macro.
 */
...
RET_STOP_REQUESTED,								/**< Received stop request via std::stop_token */
