...
#Convexification: Add scaled identities to SR1 to help it getting accepted
...
#Solve additional SR1-Hessian QPs, regularized by adding
#identities - scaled by an increasing factor κ
opts.convStrategy = 1
