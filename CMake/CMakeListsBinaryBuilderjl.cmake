...
set(SET MUMPS_INCLUDE_DIRECTORY ${INCLUDE_PREFIX}/include)


set(BLAS_INCLUDE_DIRECTORY ${INCLUDE_PREFIX}/include/libblastrampoline/LP64/common)
message(STATUS "BLAS_INCLUDE_DIRECTORY: " ${BLAS_INCLUDE_DIRECTORY})
...
target_include_directories(qpOASES
	...
	PRIVATE ${MUMPS_INCLUDE_DIRECTORY} PUBLIC ${BLAS_INCLUDE_DIRECTORY}
)
